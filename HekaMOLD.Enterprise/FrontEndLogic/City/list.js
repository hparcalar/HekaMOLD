app.controller('cityListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'City/GetCityList', function (data) {
                    ...
                    buttons: [
                        {
                            name: 'preview', cssClass: '', text: 'Düzenle', onClick: function (e) {
                                ...
                                window.location.href = HOST_URL + 'City?rid=' + e.row.data.Id;
                            }
                        }
                    ]
                }
