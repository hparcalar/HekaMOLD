app.controller('countingListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Counting/GetDataList', function (data) {
            ...
            columns: [
                { dataField: 'ReceiptNo', caption: 'Sayım No' },
                { dataField: 'CountingDateStr', caption: 'Sayım Tarihi' },
                {
                    type: "buttons",
                    buttons: [
                        {
                            name: 'preview', cssClass: '', text: 'Göster', onClick: function (e) {
                                ...
                                window.location.href = HOST_URL + 'Counting?rid=' + e.row.data.Id;
                            }
                        }
                    ]
                }
