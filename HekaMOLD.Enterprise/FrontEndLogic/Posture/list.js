app.controller('postureListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Maintenance/GetPostureList', function (data) {
            ...
            columns: [
                { dataField: 'StartDateStr', caption: 'Tarih', width:130 },
                { dataField: 'Id', caption: 'Arıza No' },
                    ...
                    buttons: [
                        {
                            name: 'preview', cssClass: '', text: 'Düzenle', onClick: function (e) {
                                ...
                                window.location.href = HOST_URL + 'Maintenance/Posture?rid=' + e.row.data.Id;
                            }
                        }
                    ]
                }
