app.controller('loadImportListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Load/GetItemLoadImportList', function (data) {
            ...
            onExporting(e) {
                ...
                const worksheet = workbook.addWorksheet('İthalat Yük Listesi');
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    workbook.xlsx.writeBuffer().then((buffer) => {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'İthalat Yük Listesi.xlsx');
                    });
                });
                e.cancel = true;
            },            filterRow: {
