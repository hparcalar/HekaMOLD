app.controller('loadExportListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Load/GetItemLoadExportList', function (data) {
            ...
            onExporting(e) {
                ...
                const worksheet = workbook.addWorksheet('İhracat Yük Listesi');
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    workbook.xlsx.writeBuffer().then((buffer) => {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'İhracat Yük Listesi.xlsx');
                    });
                });
                e.cancel = true;
            },
