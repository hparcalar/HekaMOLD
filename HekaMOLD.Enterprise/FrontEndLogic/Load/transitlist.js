app.controller('loadTransitListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Load/GetItemLoadTransitList', function (data) {
            ...
            onExporting(e) {
                ...
                const worksheet = workbook.addWorksheet('Transit Yük Listesi');
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    workbook.xlsx.writeBuffer().then((buffer) => {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Transit Yük Listesi.xlsx');
                    });
                });
                e.cancel = true;
            }, filterRow: {
