app.controller('warehouseEntryExitCtrl', function ($scope, $http) {
        ...
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    ...
                    return $.getJSON(HOST_URL + 'Warehouse/GetEntryExitList?warehouseList=' + warehouseIds, function (data) {
            ...
            columns: [
                ...
                { dataField: 'TotalQuantity', caption: 'Mevcut Miktar' },
                //{
                //    type: "buttons",
                //    buttons: [
                //        {
