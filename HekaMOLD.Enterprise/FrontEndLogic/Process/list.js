app.controller('processListCtrl', function ($scope, $http) {
    ...
    $scope.loadReport = function () {
        $('#dataList').dxDataGrid({
            dataSource: {
                load: function () {
                    return $.getJSON(HOST_URL + 'Process/GetProcessList', function (data) {
            ...
            columns: [
                ...
                {
                    dataField: 'TheoreticalDuration', caption: 'Teorik Süre(sn)',
                ...
                { dataField: 'ForexTypeCode', caption: 'Döviz Cinsi' },
                {
                    type: "buttons",
                    buttons: [
                        {
                            name: 'preview', cssClass: '', text: 'Düzenle', onClick: function (e) {
                                ...
                                window.location.href = HOST_URL + 'Process?rid=' + e.row.data.Id;
                            }
                        }
                    ]
                }
