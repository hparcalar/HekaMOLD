                ...
                else if (reportType == ReportType.Cmr)
                {
                    ...
                    if (dbObj != null)
                    {
                        ...
                        data.Add(new LoadCmrModel
                        {
                            ...
                            CmrShipperFirmName = dbObj.FirmCmrShipper != null ? dbObj.FirmCmrShipper.FirmName:"",
                            CmrShipperCountry = dbObj.CountryCmrShipper != null ? dbObj.CountryCmrShipper.CountryName : "",
                            CmrShipperCity = dbObj.CityCmrShipper != null ? dbObj.CityCmrShipper.PostCode + " " + dbObj.CityCmrShipper.CityName : "",
                            CmrShipperAddress = dbObj.CmrShipperFirmAddress,
                            CmrBuyerFirmName = dbObj.FirmCmrBuyer != null ? dbObj.FirmCmrBuyer.FirmName : "",
                            CmrBuyerCountry = dbObj.CountryCmrBuyer != null ? dbObj.CountryCmrBuyer.CountryName : "",
                            CmrBuyerCity = dbObj.CityCmrBuyer != null ? dbObj.CityCmrBuyer.PostCode + " " + dbObj.CityCmrBuyer.CityName : "",
                            CmrBuyerAddress = dbObj.CmrBuyerFirmAddress,
