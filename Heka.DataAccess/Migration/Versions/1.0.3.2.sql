...
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='ProductQualityData' AND COLUMN_NAME='Explanation')
BEGIN
	ALTER TABLE ProductQualityData ADD Explanation NVARCHAR(MAX) NULL
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='WorkOrderSerial' AND COLUMN_NAME='QualityExplanation')
BEGIN
...
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='MachineSignal' AND COLUMN_NAME='ShiftBelongsToDate')
BEGIN
	ALTER TABLE MachineSignal ADD ShiftBelongsToDate DATETIME NULL
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='ProductWastage' AND COLUMN_NAME='ShiftBelongsToDate')
BEGIN
	ALTER TABLE ProductWastage ADD ShiftBelongsToDate DATETIME NULL
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='ProductionPosture' AND COLUMN_NAME='ShiftId')
BEGIN
	ALTER TABLE ProductionPosture ADD ShiftId INT NULL
	ALTER TABLE ProductionPosture ADD CONSTRAINT FK_ProductionPosture_Shift FOREIGN KEY(ShiftId) REFERENCES Shift(Id)
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='ProductionPosture' AND COLUMN_NAME='ShiftBelongsToDate')
BEGIN
	ALTER TABLE ProductionPosture ADD ShiftBelongsToDate DATETIME NULL
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Incident' AND COLUMN_NAME='ShiftId')
BEGIN
	ALTER TABLE Incident ADD ShiftId INT NULL
	ALTER TABLE Incident ADD CONSTRAINT FK_Incident_Shift FOREIGN KEY(ShiftId) REFERENCES Shift(Id)
END
GO
IF NOT EXISTS(select * from INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Incident' AND COLUMN_NAME='ShiftBelongsToDate')
BEGIN
	ALTER TABLE Incident ADD ShiftBelongsToDate DATETIME NULL
END